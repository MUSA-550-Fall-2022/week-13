...
# Store mapping from race labels to values
# The values are the values of the 'race' column in the data
RACES = {"White": "W", "Black": "B", "All": "All"}
                    ...
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                for label, value in RACES.items()
                            ],
                            value="W",
                        ),
                    ],
...
def render(days, race):
    ...
    subtitle = (
        "There have been %d shootings and %d homicides in the last %d days." % args
    )
